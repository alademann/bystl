<?php
/*
 * Plugin Name: DD Sidebar Twitter Widget
 ...
 */
add_action( 'widgets_init', 'dd_sidebar_tweets_widgets' );

/*
 * Register widget.
 */
function dd_sidebar_tweets_widgets() {
	register_widget( 'DD_Sidebar_Tweet_Widget' );
}

/*
 * Widget class.
 */
class dd_sidebar_tweet_widget extends WP_Widget {

	/* ---------------------------- */
	/* -------- Widget setup -------- */
	/* ---------------------------- */
	
	function DD_Sidebar_Tweet_Widget() {
	
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'dd_sidebar_tweet_widget', 'description' => __('A widget that displays your latest tweets in the sidebar.', 'localization') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'dd_tweet_sidebar_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'dd_tweet_sidebar_widget', __('DD Sidebar Twitter Widget','localization'), $widget_ops, $control_ops );
	}
