/**
    ...
    License     MIT / http://bit.ly/mit-license
		...
		BROWSER / MACHINE CAPABILITY DETECTION ONLY (no css3, html5, etc... since we're using MODERNIZR for that)
		EXTRACTED FROM:
    Version     0.96
...
//    });
    ...
    window.onresize = screenSize;
		...
		// obviously if all this worked, then js is enabled in the browser.
